...
--- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---
00 | NOP <br/> nope | MVD <br/> nope | MVF <br/> nope | MVI <br/> nope | MVK <br/> nope | MVO <br/> nope | MVP <br/> nope | MVS <br/> nope | LDA <br/> nope | LDD <br/> nope | LDF <br/> nope | LDI <br/> nope | LDK <br/> nope | LDO <br/> nope | LDP <br/> nope | LDS <br/> nope
...
20 | XCA <br/> nope | XCD <br/> nope | XCF <br/> nope | XCI <br/> nope | XCK <br/> nope | XCO <br/> nope | XCP <br/> nope | XCS <br/> nope | XCB <br/> \_\_A | XCB <br/> \_LA | XCB <br/> \_\_D | XCB <br/> \_LD | XCB <br/> \_\_K | XCB <br/> \_LK | XCB <br/> \_\_P | XCB <br/> \_LP
30 | ZRA <br/> nope | ZRD <br/> nope | ZRF <br/> nope | ZRI <br/> nope | ZRK <br/> nope | ZRO <br/> nope | ZRP <br/> nope | ZRS <br/> nope | ZRB <br/> \_\_A | ZRB <br/> \_LA | ZRB <br/> \_\_D | ZRB <br/> \_LD | ZRB <br/> \_\_K | ZRB <br/> \_LK | ZRB <br/> \_\_P | ZRB <br/> \_LP
40 | FFZ <br/> nope | FFC <br/> nope | FFN <br/> nope | FFO <br/> nope | FFI <br/> nope | FFB <br/> nope | FFS <br/> nope | FFU <br/> nope | FTZ <br/> nope | FTC <br/> none | FTN <br/> nope | FTO <br/> nope | FTI <br/> nope | FTB <br/> nope | FTS <br/> nope | FTU <br/> nope 
...
70 | LUP <br/> \_\_A | LUP <br/> \_LA | LUP <br/> \_\_D | LUP <br/> \_LD | LUP <br/> \_\_K | LUP <br/> \_LK | LUP <br/> \_\_P | LUP <br/> \_LP | PSR <br/> nope | PPR <br/> nope | RTI <br/> nope | BRK <br/> nope | INA <br/> nope | OUT <br/> nope | HLT <br/> nope
80 | PSA <br/> nope | PSD <br/> nope | PSF <br/> nope | PSI <br/> nope | PSK <br/> nope | PSO <br/> nope | PSP <br/> nope | PSS <br/> nope | PSH <br/> \_\_A | PSH <br/> \_LA | PSH <br/> \_\_D | PSH <br/> \_LD | PSH <br/> \_\_K | PSH <br/> \_LK | PSH <br/> \_\_P | PSH <br/> \_LP
90 | PPA <br/> nope | PPD <br/> nope | PPF <br/> nope | PPI <br/> nope | PPK <br/> nope | PPO <br/> nope | PPP <br/> nope | PPS <br/> nope | POP <br/> \_\_A | POP <br/> \_LA | POP <br/> \_\_D | POP <br/> \_LD | POP <br/> \_\_K | POP <br/> \_LK | POP <br/> \_\_P | POP <br/> \_LP
A0 | PKA <br/> nope | PKD <br/> nope | PKF <br/> nope | PKI <br/> nope | PKK <br/> nope | PKO <br/> nope | PKP <br/> nope | PKS <br/> nope | PIK <br/> \_\_A | PIK <br/> \_LA | PIK <br/> \_\_D | PIK <br/> \_LD | PIK <br/> \_\_K | PIK <br/> \_LK | PIK <br/> \_\_P | PIK <br/> \_LP
...
D0 | ICA <br/> nope | DCA <br/> nope | NTA <br/> nope | NGA <br/> nope | SHL <br/> nope | SLC <br/> nope | SHR <br/> nope | SRC <br/> nope | INC <br/> \_LP | DEC <br/> \_LP | NOT <br/> \_LP | NEG <br/> \_LP | ICD <br/> nope | DCD <br/> nope | ICK <br/> nope  | DCK <br/> nope
E0 | 
F0 | 
